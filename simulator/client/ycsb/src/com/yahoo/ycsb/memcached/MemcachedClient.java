...
class ClientThread extends Thread
{
	 ...
	 */
	public ClientThread(MemcachedDB db, boolean dotransactions, MemcachedWorkload workload, int threadid, int threadcount, Properties props, int opcount, double targetperthreadperms)
	{
...
public class MemcachedClient
{
	...
	public static void main(String[] args)
	{
		...
		MemcachedWorkload workload = new MemcachedWorkload();
